...
public sealed record GitHubPullRequest(int Number, string HeadSha, string HeadRef, string AuthorLogin, string HtmlUrl, string Body = "", bool Merged = false, bool Closed = false);
